...
namespace PRL.Forms
{
    public partial class Statistics : Form
    {
        ...
        {
            OpenChildForm(new Forms.All_Products(), sender);
        }

        private void btn_AllProducts_MouseEnter(object sender, EventArgs e)
        {
            btn_AllProducts.Font = new Font(btn_AllProducts.Font.FontFamily, 14);
        }

        private void btn_AllProducts_MouseLeave(object sender, EventArgs e)
        {
            btn_AllProducts.Font = new Font(btn_AllProducts.Font.FontFamily, 12);
        }
