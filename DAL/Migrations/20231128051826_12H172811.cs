...
{
    public partial class _12H172811 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Idmauao = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Idchatlieu = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Idkichthuoc = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
